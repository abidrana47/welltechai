(function () {
  ...
  function hasGoogleTagScript(measurementId) {
    if (!measurementId) return false;
    var encodedId = encodeURIComponent(measurementId);
    var selectors = [
  ...
  function loadGoogleAnalytics(measurementId) {
    ...
    if (hasGoogleTagScript(measurementId)) {
  ...
  function applyAnalyticsPreference(allowed) {
    ...
    if (allowed) {
      ...
      if (typeof window.gtag === 'function') {
        ...
        if (lastAppliedAnalytics !== true) {
          trackPageView();
        }
      }
      lastAppliedAnalytics = true;
      return;
    }
